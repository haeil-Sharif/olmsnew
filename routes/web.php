...
/*Generate reports*/
route::post('/Materials/reports', ['uses'=> 'MaterialController@generateReport', 'as' => 'generateReport']);
route::post('/borrowings/reports', ['uses'=> 'IssuingController@generateBorrowReport', 'as' => 'generateBorrowReport']);
