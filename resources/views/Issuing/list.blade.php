...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                <a href="/Materials/r" class="btn btn-primary align-self-end btn-sm" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-file-pdf"></i> Generate Borrowings Report</a>
                    <h1></h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="">
                              ...
                              <!--datepicker start form-->
                              <form action="<?= url('borrowings/reports')?>" method="post" target="_blank">
                             @csrf
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <h5 class="modal-title" id="exampleModalLabel"> Generate Borrowing Report</h5>
                                    ...
                                    <button type="submit" class="btn btn-primary"><i class="fas fa-file-pdf"></i>Generate Borrowing Report</button>
                                    </div>
                                </div>
                                </div>
                            </div>
